        ...
        <div className="w-full">
            ...
            <section className="py-16 md:py-24 bg-white">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">Our Specialized Eye Care Services</h2>
            ...
            <section className="py-20 bg-white">
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-slate-600">Find answers to common questions about our procedures and treatments.</p>
                    </div>
                    <div className="space-y-4">
                        {faqs.map((faq, index) => (
                            ...
                            >
                                <summary className="flex cursor-pointer items-center justify-between p-6 text-slate-900 hover:bg-slate-100 transition-colors">
            ...
            <section className="py-16">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="bg-primary rounded-2xl p-10 md:p-16 text-center text-white relative overflow-hidden">
                        ...
                        <h2 className="text-3xl md:text-4xl font-black mb-6 relative z-10">Need a consultation? Book your slot today.</h2>
                        <p className="text-secondary mb-10 text-lg relative z-10 opacity-90">Our specialists are ready to help you see the world more clearly.</p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                            <Link to="/contact">
                                <button className="bg-accent text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-amber-600 transition-colors shadow-lg">
