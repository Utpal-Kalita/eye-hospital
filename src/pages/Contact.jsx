...
export default function Contact() {
    return (
        <div className="flex-1 max-w-[1200px] mx-auto w-full px-6 py-10 md:py-16">
            {/* Hero Header */}
            <div className="mb-12">
                <h1 className="text-slate-900 text-4xl md:text-5xl font-black leading-tight tracking-tighter mb-4">Contact & Appointments</h1>
                <p className="text-slate-600 text-lg max-w-2xl">Quality eye care is just a message away. Reach out to our specialist team in Nalbari, Assam for consultations, surgeries, or routine check-ups.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    {/* Map Placeholder */}
                    <div className="h-80 w-full bg-slate-200 rounded-xl overflow-hidden relative border border-slate-200 shadow-inner group">
                ...
                <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-primary">
                    <h2 className="text-slate-900 text-2xl font-bold mb-2">Request an Appointment</h2>
            ...
            <div className="bg-red-50 border-2 border-red-100 rounded-2xl p-8 mb-16 flex flex-col md:flex-row items-center gap-8">
                <div className="bg-red-600 text-white p-5 rounded-full animate-pulse flex-shrink-0">
                    <span className="material-symbols-outlined text-4xl leading-none">e911_emergency</span>
                </div>
                <div className="flex-1 text-center md:text-left">
                    <h3 className="text-red-800 text-2xl font-black mb-2 uppercase tracking-tight">Eye Emergency or Trauma?</h3>
                    <p className="text-red-700/80 text-lg">Chemical splashes, sudden vision loss, or direct impact injuries require immediate attention. Our trauma unit is ready 24/7.</p>
                </div>
