        ...
        <div className="w-full">
            <section className="relative h-[60vh] flex items-center overflow-hidden">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-6 w-full">
                    <div className="max-w-2xl">
                        <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight">Decades of Visionary Care.</h1>
                        <p className="text-xl text-white/90 leading-relaxed">Dedicated to restoring sight and enhancing lives across the Nalbari district and beyond through clinical excellence and compassion.</p>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8">
                        <div>
                            ...
                            <h2 className="text-4xl font-bold mt-2 mb-6 text-slate-900">Serving the Heart of Nalbari Since 1995</h2>
                        ...
                        <div className="grid grid-cols-2 gap-8 pt-8 border-t border-slate-200">
                            <div>
                                <p className="text-4xl font-bold text-primary">250k+</p>
            ...
            <section className="py-24 bg-primary text-white">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16">
                    <div className="p-10 bg-white/5 rounded-2xl border border-white/10">
                        <span className="material-symbols-outlined text-5xl mb-6 text-white/80">visibility</span>
                        <h3 className="text-3xl font-bold mb-4">Our Mission</h3>
                        <p className="text-lg text-white/80 leading-relaxed">To provide world-class, affordable, and accessible eye care services to all segments of society, utilizing cutting-edge technology and human compassion.</p>
                    </div>
                    <div className="p-10 bg-white/5 rounded-2xl border border-white/10">
                        <span className="material-symbols-outlined text-5xl mb-6 text-white/80">lightbulb</span>
                        <h3 className="text-3xl font-bold mb-4">Our Vision</h3>
                        <p className="text-lg text-white/80 leading-relaxed">To be the most trusted eye care institution in Northeast India, setting benchmarks in clinical outcomes, patient safety, and community service.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 bg-slate-50">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl font-bold mt-2 text-slate-900">World-Class Facilities</h2>
                        <p className="text-slate-600 mt-4 max-w-2xl mx-auto text-lg">We invest in the best to ensure you see the best. Our hospital is equipped with industry-leading diagnostic and surgical suites.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                            <img className="w-full h-48 object-cover rounded-xl mb-6" alt="Zeiss" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBGqPwbsdigtIFo1G-nAlhUSSsB2Tk2lceNnxldohiKwztfrOyCcKfsKBxEOZb2WMeAAotR-7_NESdfBVhDY631B3W0WbS97bEanZRYxkUQnbYqDjlX1pDYZmbfm3IcXvEb-muyPS_uFi0FfOTr3lKE8l-CCM_hk8i26Hf6ylq9ZkJYNalgljpMOsLn-YFhCJB0TeUpJLEINE673oPgVRVXY1JIFZ28poIzug0H2aRxZdIBPgD6Q4Xxs_Dw4JB9taKvZn1x6L-MhtM" loading="lazy" />
                            <h4 className="text-xl font-bold mb-3 text-slate-900">Zeiss Diagnostic Suite</h4>
                            <p className="text-slate-600">Featuring the latest Humphrey Field Analyzer and Zeiss OCT for precision imaging and glaucoma management.</p>
                        </div>
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                            ...
                            <h4 className="text-xl font-bold mb-3 text-slate-900">Modular OTs</h4>
                            <p className="text-slate-600">Sterile, high-efficiency operating theaters equipped with Lumera microscopes for complex microsurgeries.</p>
                        </div>
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                            ...
                            <h4 className="text-xl font-bold mb-3 text-slate-900">Patient Comfort</h4>
                            <p className="text-slate-600">Air-conditioned recovery bays and priority lounges designed for a stress-free healing environment.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 px-6 border-b border-slate-200">
                <div className="max-w-7xl mx-auto text-center">
                    <h2 className="text-3xl font-bold mb-12 text-slate-900">Accreditations & Trust</h2>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2 space-y-6">
                            ...
                            <h2 className="text-4xl font-bold text-slate-900">Bringing Light to Rural Assam</h2>
                            <p className="text-lg text-slate-600 leading-relaxed">
